...
const TravelMap = () => {
  ...
  return (
    <div ref={mapRef} className="jl-venue-map" aria-label="Travel map">
      <svg viewBox="0 0 640 258" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Map label */}
        <text x="544" y="20" textAnchor="middle" fontFamily="DM Sans, sans-serif" fontSize="9" fontWeight="500" fill="#6F695A" letterSpacing="0.22em" opacity="0.55">GETTING HERE</text>
        ...
        <text x="264" y="198" textAnchor="middle" fontFamily="Cormorant Garamond, serif" fontSize="10.5" fontStyle="italic" fill="#1E47B5">July 2027</text>
      </svg>
    </div>
  );
};
